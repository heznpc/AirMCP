...
- **Headline for current resubmission**: "Approval-gated local action runtime for Apple workspaces — 295 tools across 29 modules with profiles, progressive tool exposure, workflow skills, context memory, queryable audit log, sensitive-action HITL, OAuth 2.1, and inbound HTTP `allowNetwork` policy."
...
- Broad tool surface plus workflow-first entry points (295 tools, 29 modules, curated workflow catalog)
