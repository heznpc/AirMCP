...
| [0015](./0015-modular-install-and-task-harness.md) | Modular install and task-scoped harness                 | Pack Contract Implemented | v2.15.0 task harness · module-pack contract      |
