...
| ------------------------------ | ------------------------------------------------ | ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Anthropic MCP Registry**     | Pending (submitted via Google Form, no response) | 2026-03-28                                | **Resubmit now** with the current description below — new differentiators: `.mcpb` one-click install, OAuth 2.1 + Resource Indicators, profiles, progressive tool exposure, 230 AppIntents |
...
- [ ] `server.json` `description` reflects current headline features (`.mcpb` one-click, OAuth 2.1, profiles, progressive tool exposure, 230 AppIntents, skills, memory, audit, inbound HTTP `allowNetwork`)
...
- **Headline for current resubmission**: "Approval-gated local action runtime for Apple workspaces — 289 tools across 29 modules with profiles, progressive tool exposure, workflow skills, context memory, queryable audit log, sensitive-action HITL, OAuth 2.1, and inbound HTTP `allowNetwork` policy."
...
- Broad tool surface plus workflow-first entry points (289 tools, 29 modules, curated workflow catalog)
