...
Runs `scripts/qa-test.mjs`. Exercises every read-only tool across all 31 modules. Does not modify any data. Safe to run anytime. Outputs a Markdown report with PASS/SKIP/FAIL status per tool.
